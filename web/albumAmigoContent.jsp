        ...
        <div class="usuariodefault">
            ...
            <h5><%=Util.amigoPerfil.getUsuario_username()%></h4>
                <h5><%=Util.amigoPerfil.getUsuario_ubicacion()%></h4>
                    ...
                    <a  href="albumAmigo.jsp" class="h10"><%=Util.amigoPerfil.getUsuario_nombre()%> Albums</a>
                        ...
                        <div class="titulo">
                            ...
                            <div id="myCarousel" class="carousel slide">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <%
                                        AlbumAmigoContentControlador.traerContenido(Util.posAlbum, Util.amigoPerfil);
                    ...
                    <div class="columnright2" style="width: 25%;">
                        ...
                        <h2 style="position: relative;"><%=Util.amigoPerfil.getUsuario_albums().get(Util.posAlbum).getAlbum_nombre()%></h2>

                        <%          int likeAlbum = Util.amigoPerfil.getUsuario_albums().get(Util.posAlbum).getAlbum_likes();
                            int dislikeAlbum = Util.amigoPerfil.getUsuario_albums().get(Util.posAlbum).getAlbum_dislikes();
                        %>
                        ...
                        <div class="agregarComentario" style="top: 17%;float: left;">
                            <form name="formAgregarComentario">
                                ...
                                <textarea style="position: absolute;
                                          ...
                                          width: 56%;
                                          height: 15%;
                                          top: 29%;" name="comentario"></textarea>

                                <a type="submit" onclick="document.formAgregarComentario.submit();" class="btn btn-large btn-block btn-primary" style="position: absolute;
                                   width: 8%;
                                   margin-top: 7%;
                                   line-height: 20%;
                                   top: 32%;
                        ...
                        <div class="comentarios" style="position: relative; top: 36%; float: left;">

                            <%

                                CargarComentarioControlador.cargarComentario(Util.amigoPerfil);
            ...
            window.location = "resultFriends.jsp";
                    ...
                    <%
                        ...
                        if ((request.getParameter("agregarComentario") != null) && (Util.reply == false)) {
                            ...
                            ComentarioControlador.AgregarComentario(comentario,
                                    Util.amigoPerfil.getUsuario_albums().get(Util.posAlbum).getAlbum_id(), Util.usuario.getUsuario_id(), Util.amigoPerfil);
                    ...
                    <%
                        ...
                        if ((request.getParameter("agregarComentario") != null) && (Util.reply == true)) {
                            ...
                            AlbumAmigoContentControlador.agregarReply(Util.posComentario, request.getParameter("agregarComentario"), Util.amigoPerfil);
                            Util.reply = false;
                    ...
                    <%
                        ...
                        if ((request.getParameter("like") != null) && (request.getParameter("comentario") != null)) {
                            ...
                            AlbumAmigoContentControlador.modificarComentario(posComentario, like, Util.amigoPerfil);
                    %>
                    ...
                    <%
                        ...
                        if (request.getParameter("rating") != null) {
                            ...
                            AlbumAmigoContentControlador.modificarRatingAlbum(rating, Util.amigoPerfil, Util.usuario);
                    %>
