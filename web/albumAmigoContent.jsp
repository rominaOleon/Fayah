  ...
  <option value="soundcloud">SoundCloud</option>
    ...
    <div class="columnright">
      ...
      <div class="carousel-inner">
          ...
          <%
              AlbumAmigoContentControlador.traerContenido(Util.posAlbum);
      ...
      <a class="carousel-control right" href="#myCarousel" data-slide="next">&rsaquo;</a>
          ...
          <div class="columnright2" style="width: 25%;">
                ...
                <h2 style="position: relative;left: 31%;top: 10%;"><%=Util.amigoPerfil.getUsuario_albums().get(Util.posAlbum).getAlbum_nombre()%></h2>
...
if ((request.getParameter("agregarComentario")!=null)&& (Util.reply==false)){
   ...
   Util.amigoPerfil.getUsuario_albums().get(Util.posAlbum).getAlbum_id(), Util.usuario.getUsuario_id());
