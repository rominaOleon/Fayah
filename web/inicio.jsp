            ...
            window.location = "perfilAmigo.jsp";
                    ...
                    <%                               }
                        ...
                        if (tipo.compareTo("album") == 0) {
                            ...
                            int idAlbum = Util.notificaciones.get(posicionNot).getFk_album_id();

                            int redirect = InicioControlador.albumAmigo(idAlbum);
                    ...
                    <%                               }
                        ...
                        if (tipo.compareTo("like") == 0) {
                            ...
                            int idLike = Util.notificaciones.get(posicionNot).getFk_like_id();

                            int idAlbum = InicioControlador.likeAlbum(idLike);
                            int redirect = InicioControlador.albumAmigo(idAlbum);
                    ...
                    <%                               }
                        ...
                        if (tipo.compareTo("dislike") == 0) {
                            ...
                            int idDislike = Util.notificaciones.get(posicionNot).getFk_dislike_id();

                            int idAlbum = InicioControlador.dislikeAlbum(idDislike);
                            int redirect = InicioControlador.albumAmigo(idAlbum);
